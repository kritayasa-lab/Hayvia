        ...
        <div>
          ...
          <Section title="Property Features">
            <ul className="grid grid-cols-1 gap-3 sm:grid-cols-2">
              <FeatureItem
                label={`Type: ${property.propertyType}`}
              />
          ...
          <Section title="Location">
            <p className="leading-relaxed text-ink-soft">
              {property.location}, {property.district}. Exact
              building details are shared once we connect you
          ...
          <Section title="Important Information">
            <p className="text-sm leading-relaxed text-ink-faint">
              This listing is a selected property shared on
              behalf of a local property owner or agent.
              Property availability, pricing and rental terms
              may change — please confirm current details
              before making any decisions. HAYVIA does not own
              or manage this property.
            </p>
          </Section>
        </div>
        ...
        <div className="lg:sticky lg:top-24 lg:h-fit">
          ...
          <div className="mt-6 rounded border border-line-soft bg-surface p-5">
            ...
            <p className="mt-1.5 text-sm text-ink-soft">
              Tell us your requirements and we'll suggest other
              suitable options.
            </p>
...
function FeatureItem({ label }: { label: string }) {
  return (
    <li className="flex items-center gap-2.5 text-sm text-ink-soft">
      <CheckCircle2
        size={16}
        className="flex-shrink-0 text-moss-500"
      />
