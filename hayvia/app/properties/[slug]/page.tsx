...
// fallback — see lib/properties-source.ts), so this page is rendered
// dynamically per request rather than statically pre-built. `dynamicParams`
// defaults to true, so any slug — sheet-sourced or demo — resolves here.
        ...
        <div>
          ...
          <Section title="Important Information">
            <p className="text-sm leading-relaxed text-ink-faint">
              ...
              — please confirm current details before making any decisions. Subphiphat Real Estate does
