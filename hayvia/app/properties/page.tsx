...
import { resolveInitialFilters } from "@/lib/properties-filters";
...
export default async function PropertiesPage({
  ...
  searchParams: { listingType?: string; location?: string; type?: string };
}) {
  ...
  return (
    <Container className="py-10 sm:py-14">
      ...
      <div className="mt-8">
        <PropertiesExplorer properties={properties} initialFilters={initialFilters} />
      </div>
    </Container>
  );
}
